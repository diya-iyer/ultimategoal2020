...
@Autonomous(name="ShooterWobbleGoalC8", group="Thunderbots")
public class UGAutonomousWobbleGoalShootC8 extends UGTowerGoalBaseAuto {
    ...
    public void shootAndPark() {
       ...
       /* for (int a = 1; a <= 3; a++) {
        ...
        encoderDrive(powerMultiplier, 24, 24, 2.5);
