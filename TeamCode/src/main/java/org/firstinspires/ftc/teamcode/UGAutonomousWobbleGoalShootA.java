...
@Autonomous(name="ShootWobbleGoalA", group="Thunderbots")
public class UGAutonomousWobbleGoalShootA extends UGTowerGoalBaseAuto {
    ...
    public void shootAndPark() {
        ...
        double triggerPosition = robot.wobbleClawServo
                .getPosition();
